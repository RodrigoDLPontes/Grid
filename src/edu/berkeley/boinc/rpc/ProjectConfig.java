...
public class ProjectConfig {
	...
	public String localRevision = ""; // e.g. 4.3.2 can't be parse as int or
								// float.
	...
	/**
	 * Returns the URL for HTTPS requests, if available. master URL otherwise.
	 * Use HTTPS URL for account look up and registration CAUTION: DO NOT use
	 * HTTPS URL for attach!
	 * 
