...
public class CcStateParser extends BaseParser {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if(qName.equalsIgnoreCase("client_state")) {
		...
		if(qName.equalsIgnoreCase("app_version")) {
		...
		if(qName.equalsIgnoreCase("core_client_major_version") || qName.equalsIgnoreCase("core_client_minor_version") || qName.equalsIgnoreCase("core_client_release") || qName.equalsIgnoreCase("have_ati") || qName.equalsIgnoreCase("have_cuda")) {
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		try {
			if(mInHostInfo) {
				// We are inside <host_info>
				// parse it by sub-parser in any case (to parse also closing
				// element)
			...
			if(mInProject) {
				// We are inside <project>
				// parse it by sub-parser in any case (must parse also
				// closing element!)
			...
			if(mElementStarted) {
				trimEnd();
				// VersionInfo?
				if(qName.equalsIgnoreCase("core_client_major_version")) {
					mVersionInfo.major = Integer.parseInt(mCurrentElement.toString());
				} else if(qName.equalsIgnoreCase("core_client_minor_version")) {
					mVersionInfo.minor = Integer.parseInt(mCurrentElement.toString());
				} else if(qName.equalsIgnoreCase("core_client_release")) {
					mVersionInfo.release = Integer.parseInt(mCurrentElement.toString());
				} else if(qName.equalsIgnoreCase("have_ati")) {
					mCcState.have_ati = !mCurrentElement.toString().equals("0");
				} else if(qName.equalsIgnoreCase("have_cuda")) {
