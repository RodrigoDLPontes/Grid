...
public class ProjectsParser extends BaseParser {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		} else if(qName.equalsIgnoreCase("gui_url")) {
			mGuiUrl = new GuiUrl();
		} else {
			...
			if(mProject != null) {
				...
				if(qName.equalsIgnoreCase("project")) {
					...
					if(mGuiUrl != null) {
						...
						if(qName.equalsIgnoreCase("gui_url")) {
					...
					} else if(qName.equalsIgnoreCase("project_dir")) {
						mProject.project_dir = mCurrentElement.toString();
					} else if(qName.equalsIgnoreCase("resource_share")) {
					...
					} else if(qName.equalsIgnoreCase("team_name")) {
						mProject.team_name = mCurrentElement.toString();
					} else if(qName.equalsIgnoreCase("hostid")) {
						mProject.hostid = Integer.parseInt(mCurrentElement.toString());
					} else if(qName.equalsIgnoreCase("host_venue")) {
