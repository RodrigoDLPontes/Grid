...
public class GlobalPreferencesParser extends BaseParser {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if(qName.equalsIgnoreCase("global_preferences")) {
			mPreferences = new GlobalPreferences();
		} else if(qName.equalsIgnoreCase("day_prefs")) {
			if(mInsideDayPrefs) mInsideDayPrefs = true;
		} else {
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		try {
			if(mPreferences != null) {
				...
				if(qName.equalsIgnoreCase("global_preferences")) {
					// Closing tag of <global_preferences> - nothing to do
					// at the moment
				} else if(qName.equalsIgnoreCase("day_prefs")) {
					// closing <day_prefs>
					...
					trimEnd();
					if(qName.equalsIgnoreCase("day_of_week")) {
						mDayOfWeek = Integer.parseInt(mCurrentElement.toString());
					} else if(qName.equalsIgnoreCase("start_hour")) {
					...
					} else if(qName.equalsIgnoreCase("end_hour")) {
						if(mTempCpuTimeSpan == null) mTempCpuTimeSpan = new TimePreferences.TimeSpan();
						mTempCpuTimeSpan.end_hour = Double.parseDouble(mCurrentElement.toString());
					} else if(qName.equalsIgnoreCase("net_start_hour")) {
					...
					} else if(qName.equalsIgnoreCase("net_end_hour")) {
						if(mTempNetTimeSpan == null) mTempNetTimeSpan = new TimePreferences.TimeSpan();
					...
					} else if(qName.equalsIgnoreCase("override_file_present")) {
						mPreferences.override_file_present = Integer.parseInt(mCurrentElement.toString()) != 0;
					} else if(qName.equalsIgnoreCase("network_wifi_only")) {
