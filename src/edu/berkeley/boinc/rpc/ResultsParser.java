...
public class ResultsParser extends BaseParser {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if(qName.equalsIgnoreCase("result")) {
			mResult = new Result();
		} else if(qName.equalsIgnoreCase("active_task")) {
			mInActiveTask = true;
		} else {
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		try {
			if(mResult != null) {
				...
				if(qName.equalsIgnoreCase("result")) {
					// Closing tag of <result> - add to vector and be ready
					// for
					// next one
					...
					if(mInActiveTask) {
						...
						} else if(qName.equalsIgnoreCase("graphics_exec_path")) {
							mResult.graphics_exec_path = mCurrentElement.toString();
						} else if(qName.equalsIgnoreCase("slot_path")) {
						...
						} else if(qName.equalsIgnoreCase("wu_name")) {
							mResult.wu_name = mCurrentElement.toString();
						} else if(qName.equalsIgnoreCase("project_url")) {
						...
						} else if(qName.equalsIgnoreCase("ready_to_report")) {
							mResult.ready_to_report = !mCurrentElement.toString().equals("0");
						} else if(qName.equalsIgnoreCase("got_server_ack")) {
							mResult.got_server_ack = !mCurrentElement.toString().equals("0");
						} else if(qName.equalsIgnoreCase("final_cpu_time")) {
							mResult.final_cpu_time = Double.parseDouble(mCurrentElement.toString());
						} else if(qName.equalsIgnoreCase("final_elapsed_time")) {
						...
						} else if(qName.equalsIgnoreCase("project_suspended_via_gui")) {
							mResult.project_suspended_via_gui = !mCurrentElement.toString().equals("0");
						} else if(qName.equalsIgnoreCase("resources")) {
